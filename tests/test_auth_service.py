...
class TestAuthServiceRegister(unittest.TestCase):
    ...
    def test_register_whitespace_trimming(self):
        ...
        response = requests.post(
            f"{BASE_URL}/api/auth/register",
            json={"username": username_with_spaces, "password": password_with_spaces}
        )
...
class TestAuthServiceLogin(unittest.TestCase):
    ...
    def test_login_nonexistent_user(self):
        ...
        response = requests.post(
            f"{BASE_URL}/api/auth/login",
            json={"username": "nonexistent_user_12345", "password": self.test_password}
        )
    ...
    def test_login_case_sensitive_username(self):
        ...
        response = requests.post(
            f"{BASE_URL}/api/auth/login",
            json={"username": self.test_username.upper(), "password": self.test_password}
        )
