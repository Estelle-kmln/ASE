...
class TestAuthServiceRegister(APIGatewayTestCase):
...
class TestAuthServiceLogin(APIGatewayTestCase):
...
class TestAuthServiceProfile(APIGatewayTestCase):
...
class TestAuthServiceTokenValidation(APIGatewayTestCase):
...
class TestAuthServiceEdgeCases(APIGatewayTestCase):
    ...
    def test_register_with_very_long_username(self):
        ...
        unique_id = int(time.time() * 1000)
        long_username = "a" * 200 + f"_{unique_id}"
